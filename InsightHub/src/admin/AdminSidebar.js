    ...
    return (
        <>
            <div className={`sidebar d-flex flex-column ${sidebarOpen ? '' : 'collapsed'}`} id="sidebar">
                ...
                <NavLink to="/admin/bloglist" className="nav-link" activeClassName="active">
                    <GrArticle /> <span className="nav-label">Blogs</span>
                </NavLink>
                <NavLink to="/admin/topics" className="nav-link" activeClassName="active">
                    <MdOutlineFormatColorText /> <span className="nav-label">Topics</span>
                </NavLink>
                <NavLink to="/admin/addtopic" className="nav-link" activeClassName="active">
